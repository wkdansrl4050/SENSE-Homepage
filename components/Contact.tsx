      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start mt-8 pb-20">
        ...
        <div className="space-y-8 pt-0 md:pt-10">
          ...
          <a 
            ...
            className="block relative group overflow-hidden rounded-[2rem] h-72 shadow-xl border border-gray-100 cursor-pointer bg-gray-100"
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              <div className="px-8 py-3 bg-[#2E7D32] text-white font-black rounded-full flex items-center space-x-3 shadow-2xl">
            ...
            <div className="absolute bottom-8 left-8 text-white">
              ...
              <h4 className="text-2xl font-black italic drop-shadow-lg">Keimyung University</h4>
            </div>
          </a>
        </div>
      </div>
